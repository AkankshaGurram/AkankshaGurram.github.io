/* ============================================
   AKANKSHA GURRAM - PORTFOLIO JAVASCRIPT
...
function initTypingEffect() {
    ...
    const roles = [
        ...
        'Financial Data Storyteller',
        'A/B Testing Enthusiast',
        'Cloud Data Engineer'
    ];
...
function initFormHandler() {
    ...
    form.addEventListener('submit', (e) => {
        ...
        // Create mailto link
        const mailtoLink = `mailto:g.akankshareddy.23@gmail.com?subject=${encodeURIComponent(data.subject)}&body=${encodeURIComponent(
            `Name: ${data.name}\nEmail: ${data.email}\n\nMessage:\n${data.message}`
        )}`;
...
/* ============================================
   CONSOLE EASTER EGG
   ============================================ */
console.log('%c Welcome to Akanksha Gurram\'s Portfolio! ',
